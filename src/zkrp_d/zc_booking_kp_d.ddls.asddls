...
define view entity ZC_Booking_KP_D
  as projection on ZKP_BOOKING_D
{
  key BookingUUID,
...
//        ]
     @Consumption.valueHelpDefinition: [ {entity: {name: '/DMO/I_Flight', element: 'ConnectionID'},
      ...
      /* Associations */
      _BookingSupplement : redirected to composition child ZC_BookSuppl_KP_D,
      _BookingStatus,
      _Carrier,
      _Connection,
      _Customer,
      _Travel            : redirected to parent ZC_TRAVEL_KP_D
}
